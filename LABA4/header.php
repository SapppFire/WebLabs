            ...
            <div class="row">
                ...
                <div class="col">
                    ...
                    ?>
                        ...
                        <div style="color: white"><a href="authorization.php" style="background-color: white; color: #f02d37">Ввести логин и пароль</a> или <a href="registration.php" style="background-color: white; color: #f02d37">Зарегистрироваться</a></div>
                    <?php
                        }
                    ?>
                    </div>
    ...
    <div class="container text-center">
        <div class="common-second-section-menu">
            <div class="row">
                ...
                <div class="col">
                    <a href="laba4/text.php" target="_blank"><img class="one-section">ТЕКСТ</a>
                </div>
            </div>
        </div>
    </div>
