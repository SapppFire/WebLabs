...
--
-- Хост: 127.0.0.1
-- Время создания: Ноя 04 2024 г., 17:45
...
(9, 9, 'Поле на возвышенности'),
(10, 10, 'Плодородное поле с черноземом'),
(11, 11, 'Сухая степная зона'),
(12, 12, 'Глинистая почва на склоне'),
(13, 13, 'Сухая степная зона'),
(14, 14, 'Поле на возвышенности'),
(15, 15, 'Земля с подземными водами'),
(16, 16, 'Поле у лесополосы'),
(17, 17, 'Земля с подземными водами'),
(18, 18, 'Поле с влажной почвой'),
(19, 19, 'Поле с устойчивой влажностью'),
(20, 20, 'Поле в горной местности');
...
(6, '6.jpg', 'Томаты', 6, 'Томаты для соусов Heinz', 320.50),
(7, '7.jpg', 'Огурцы', 7, 'Огурцы для прикола', 210.00),
(8, '8.jpg', 'Рис', 8, 'Рис с высокими урожаями', 400.00),
...
(12, '12.jpg', 'Подсолнечник', 12, 'Подсолнечник для масла', 320.00),
(13, '13.jpg', 'Картофель', 13, 'Картофель высокого качества', 150.00),
(14, '14.jpg', 'Пшеница', 14, 'Пшеница для кормов и удобрений', 175.00),
(15, '15.jpg', 'Чеснок', 15, 'Чеснок с высокой насыщенностью', 500.00),
(16, '16.jpg', 'Свекла', 16, 'Свекла для производства сахара', 190.00),
(17, '17.jpg', 'Хмель', 17, 'Хмель для пивоварения', 300.00),
(18, '18.jpg', 'Мак', 18, 'Мак для опиума', 145.00),
(19, '19.jpg', 'Томаты', 19, 'Томаты для консервирования', 340.00),
(20, '20.jpg', 'Огурцы', 20, 'Огурцы для свежего потребления', 220.00);
